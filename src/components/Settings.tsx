...
import { Building2, Code, CreditCard, Clock, Mail, Upload, ChevronDown, Check, TrendingDown, Gift } from 'lucide-react';
...
type SettingsTab = 'rooms' | 'widget' | 'stripe' | 'hours' | 'email' | 'gift-card-email' | 'hosting' | 'abandoned';
...
export function Settings() {
  ...
  const settingsOptions: SettingsOption[] = [
    ...
    { id: 'gift-card-email', icon: Gift, label: 'Geschenkgutscheine & Voucher verwalten/einstellungen' },
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        {activeTab === 'gift-card-email' && <GiftCardEmailSettings />}
        {activeTab === 'hosting' && (
          <div className="space-y-6">
