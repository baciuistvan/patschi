...
import { LogOut, LayoutGrid, Calendar, Settings as SettingsIcon, Menu, X, Home, Globe, Sun, Moon, Users, ChevronDown, Gift } from 'lucide-react';
...
type View = 'home' | 'floor-plan' | 'reservations' | 'settings' | 'user-management';
          ...
          {mobileMenuOpen && (
            <div className="lg:hidden py-4 space-y-2">
              ...
              <div className="sm:hidden border-t border-slate-700 pt-3 mt-3">
                ...
                <p className="text-xs text-slate-400 px-4">{adminUser?.role}</p>
              </div>
            </div>
          )}
        </div>
