...
const getHTML = (bookingCode: string) => `<!DOCTYPE html>
<html lang="de">
<head>
  <meta charset="UTF-8">
...
<body class="bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 min-h-screen flex items-center justify-center p-4">
  ...
  <div id="loadingState" class="max-w-md w-full">
    <div class="bg-white rounded-3xl shadow-2xl p-8 text-center fade-in">
      <div class="spinner mx-auto mb-4"></div>
      <p class="text-gray-600">Reservierung wird geladen...</p>
    </div>
  </div>

  <div id="successState" class="max-w-2xl w-full hidden">
    <div class="bg-white rounded-3xl shadow-2xl overflow-hidden fade-in">
      ...
      <div class="p-8">
        ...
        <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 mb-6 border-2 border-green-200 text-center">
          ...
          <p class="text-4xl font-bold text-green-700 tracking-wider font-mono" id="bookingCode">-</p>
        ...
        <div class="space-y-4 mb-6" id="reservationDetails">
          ...
          <div class="flex items-start gap-4 p-4 bg-gray-50 rounded-xl">
            ...
            <div class="flex-1">
              ...
              <p class="font-semibold text-gray-900" id="guestName">-</p>
            </div>
          </div>
          ...
          <div class="flex items-start gap-4 p-4 bg-gray-50 rounded-xl">
            ...
            <div class="flex-1">
              ...
              <p class="font-semibold text-gray-900" id="roomName">-</p>
            </div>
          </div>
          ...
          <div class="flex items-start gap-4 p-4 bg-gray-50 rounded-xl">
            ...
            <div class="flex-1">
              ...
              <p class="font-semibold text-gray-900" id="dateTime">-</p>
            </div>
          </div>
          ...
          <div class="flex items-start gap-4 p-4 bg-gray-50 rounded-xl">
            ...
            <div class="flex-1">
              ...
              <p class="font-semibold text-gray-900" id="guests">-</p>
            </div>
          </div>

          <div class="flex items-start gap-4 p-4 bg-gray-50 rounded-xl" id="specialRequestsSection" style="display: none;">
            ...
            <div class="flex-1">
              ...
              <p class="text-gray-900" id="specialRequests">-</p>
            </div>
          </div>
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-xl p-5 mb-6">
          <div class="flex items-start gap-3">
            ...
            <div>
              ...
              <p class="text-sm text-blue-700">Eine detaillierte Bestätigung wurde an <span class="font-semibold" id="guestEmail">Ihre E-Mail-Adresse</span> gesendet.</p>
            </div>
          </div>
        </div>
  ...
  <div id="errorState" class="max-w-md w-full hidden">
    <div class="bg-white rounded-3xl shadow-2xl p-8 text-center fade-in">
  ...
  <script>
    ...
    const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InF3d2Vyd2tla3ZtYXN3dXN2Z3h5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzI1NDU4NzcsImV4cCI6MjA0ODEyMTg3N30.tOT6gDmgwz1W65f4o1YkuLIwAY0fzG3dBWNckUoY3P0';
    ...
    function displayReservation(reservation) {
      ...
      if (reservation.special_requests) {
        ...
        document.getElementById('specialRequestsSection').style.display = 'flex';
      }
...
Deno.serve(async (req: Request) => {
  try {
    ...
    return new Response(getHTML(bookingCode), {
      status: 200,
      headers: {
